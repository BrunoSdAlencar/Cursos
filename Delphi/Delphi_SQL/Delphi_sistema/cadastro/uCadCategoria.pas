...
begin
  ...
  if Assigned(oCategoria) then
    // FreeAndNil destroe o objeto após o uso, ajuda a limpar a mémoria.
...
// Erro quando e inserido um nome que ja esteve na DB e foi deletado
// anteriormente informa que não pode repetir uma primary key
begin
