object frmRelCadClienteFicha: TfrmRelCadClienteFicha
  ...
  object Relatorio: TRLReport
    ...
    object RLBand2: TRLBand
      ...
      object rldbtxtbairro1: TRLDBText
        Left = 619
        Top = 58
        Width = 43
        Height = 16
      ...
      object rldbtxtbairro2: TRLDBText
        Left = 143
        Top = 102
        Width = 98
        Height = 16
  ...
  object QryCliente: TZQuery
    ...
    object wdstrngfldQryClientecep: TWideStringField
      FieldName = 'cep'
      Size = 10
    end
    object wdstrngfldQryClienteendereco: TWideStringField
      FieldName = 'endereco'
      Size = 60
    end
    object wdstrngfldQryClientebairro: TWideStringField
      FieldName = 'bairro'
      Size = 40
    end
    object wdstrngfldQryClientecidade: TWideStringField
      FieldName = 'cidade'
      Size = 50
    end
    object wdstrngfldQryClienteestado: TWideStringField
      FieldName = 'estado'
      Size = 2
    end
    ...
    object dtmfldQryClientedataNascimento: TDateTimeField
